...
connection = pymysql.connect(host='127.0.0.1', user='root', password='123456789')
...
st.set_page_config(
    ...
    page_icon='E:/New folder 1/Smart_Resume_Analyser_App-master/Logo/SRA_Logo.ico'
)
...
def run():
    ...
    img = Image.open('E:/New folder 1/Smart_Resume_Analyser_App-master/Logo/SRA_Logo.jpg')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            #     time.sleep(4)
            save_image_path = 'D:/Smart_Resume_Analyser_App-master/Uploaded_Resumes'+ pdf_file.name
